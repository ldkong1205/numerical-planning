...
clear all;
format long;
global alpha r q0 T lambda sigma aa alpha_i a_i d_i D sa ca s2a c2a pen_long k tt errorr; 
...
qj=[1.670;2.845;-3.218;4.182;-1.715;-2.655];          %????????????????????
q0=qj;%an initial state q0

global mu_p mu_v qP qM qDp qDm qDDp qDDm myInf n m Pinfty Minfty gamma nu beta Time;
n=6;                                    %??????????????6??????
m=3;                                    %??????????????????????????????3??????????
nu=2500;
gamma=500;   %????????????DNN????alpha  50
...
%??????????????
save mvn_SYSdata u0 aa beta sigma r alpha lambda alpha_i a_i d_i D sa ca s2a c2a pen_long q0 T mu_p mu_v qP qM qDp qDm qDDp qDDm m Pinfty Minfty gamma n myInf Time k;
